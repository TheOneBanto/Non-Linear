...
public class myMain_A01_Part1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("How many nodes on myTree1 are smaller than 7? " + myTree1.my_count_smaller_nodes(7));
		...
		System.out
				.println("What is the level of the node with key 11 on myTree3? " + myTree2.my_find_node_at_level(11));
